...
/**
 * Ana sayfayı kapatan ışık bölgesi: alıntı + "bize katıl" (F4-01 · 19.08.2026).
 *
...
export function IsikBolgesi({
  ...
  return (
    <div className="relative overflow-hidden">
      {/* Varsayılan `top-30` (7.5rem) alıntı metninin hizası: bölüm `pt-24` +
          üst çizgi + blockquote'un `my-7` üst boşluğu ≈ 125 px. Huzmeler bu
          yüzden alıntının üstünde başlamıyor, tam onun hizasından iniyor. */}
      <IsikHuzmeleri />

      {alinti ? (
        <AlintiBandi alinti={alinti} className="relative pt-24 sm:pt-28" />
      ) : null}
